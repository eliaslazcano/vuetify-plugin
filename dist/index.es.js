...
import { getCurrentInstance as yt, ref as Vt, computed as Bs, watch as ut, onMounted as Zs } from "vue";
...
const lr = or.exports;
var ur = Object.defineProperty, dr = (e, t, s) => t in e ? ur(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : e[t] = s, De = (e, t, s) => dr(e, typeof t != "symbol" ? t + "" : t, s);
const Ut = {
  "#": { pattern: /[0-9]/ },
  "@": { pattern: /[a-zA-Z]/ },
  "*": { pattern: /[a-zA-Z0-9]/ }
...
}, Qt = (e) => JSON.parse(e.replaceAll("'", '"')), fr = (e, t = {}) => {
  const s = { ...t };
  e.dataset.maska != null && e.dataset.maska !== "" && (s.mask = hr(e.dataset.maska)), e.dataset.maskaEager != null && (s.eager = Fe(e.dataset.maskaEager)), e.dataset.maskaReversed != null && (s.reversed = Fe(e.dataset.maskaReversed)), e.dataset.maskaTokensReplace != null && (s.tokensReplace = Fe(e.dataset.maskaTokensReplace)), e.dataset.maskaTokens != null && (s.tokens = mr(e.dataset.maskaTokens));
  const r = {};
...
}, Fe = (e) => e !== "" ? !!JSON.parse(e) : !0, hr = (e) => e.startsWith("[") && e.endsWith("]") ? Qt(e) : e, mr = (e) => {
  ...
  return e.split("|").forEach((s) => {
    const r = s.split(":");
    t[r[0]] = {
      pattern: Kt() ? new RegExp(r[1], "u") : new RegExp(r[1]),
...
class pr {
  constructor(t = {}) {
    ...
    if (s.tokens != null) {
      ...
      for (const r of Object.values(s.tokens))
        typeof r.pattern == "string" && (r.pattern = Kt() ? new RegExp(r.pattern, "u") : new RegExp(r.pattern));
    } else
      s.tokens = Ut;
  ...
  process(t, s, r = !0) {
    if (this.opts.number != null) return cr(t, r, this.opts);
    if (s == null) return t;
    const a = `v=${t},mr=${s},m=${r ? 1 : 0}`;
    if (this.memo.has(a)) return this.memo.get(a);
    const { mask: n, escaped: i } = this.escapeMask(s), o = [], c = this.opts.tokens != null ? this.opts.tokens : {}, u = this.isReversed() ? -1 : 1, g = this.isReversed() ? "unshift" : "push", b = this.isReversed() ? 0 : n.length - 1, x = this.isReversed() ? () => k > -1 && R > -1 : () => k < n.length && R < t.length, L = (oe) => !this.isReversed() && oe <= b || this.isReversed() && oe >= b;
    let re, U = -1, k = this.isReversed() ? n.length - 1 : 0, R = this.isReversed() ? t.length - 1 : 0, rt = !1;
    for (; x(); ) {
      const oe = n.charAt(k), z = c[oe], We = (z == null ? void 0 : z.transform) != null ? z.transform(t.charAt(R)) : t.charAt(R);
      if (!i.includes(k) && z != null ? (We.match(z.pattern) != null ? (o[g](We), z.repeated ? (U === -1 ? U = k : k === b && k !== U && (k = U - u), b === U && (k -= u)) : z.multiple && (rt = !0, k -= u), k += u) : z.multiple ? rt && (k += u, R -= u, rt = !1) : We === re ? re = void 0 : z.optional && (k += u, R -= u), R += u) : (r && !this.isEager() && o[g](oe), We === oe && !this.isEager() ? R += u : re = oe, this.isEager() || (k += u)), this.isEager())
...
const at = /* @__PURE__ */ new WeakMap(), yr = (e, t) => {
  ...
  at.has(r) ? (s = at.get(r)) == null || s.update(a) : at.set(r, new _r(r, a));
};
//! moment.js
//! version : 2.30.1
...
var jt = d.momentProperties = [], nt = !1;
function kt(e, t) {
...
function Pe(e) {
  kt(this, e), this._d = new Date(e._d != null ? e._d.getTime() : NaN), this.isValid() || (this._d = /* @__PURE__ */ new Date(NaN)), nt === !1 && (nt = !0, d.updateOffset(this), nt = !1);
}
function E(e) {
...
var Gt = {};
function ss(e, t) {
  d.deprecationHandler != null && d.deprecationHandler(e, t), Gt[e] || (ts(t), Gt[e] = !0);
}
...
function ct(e, t) {
  var s = ae({}, e), r;
  for (r in t)
    y(t, r) && (de(e[r]) && de(t[r]) ? (s[r] = {}, ae(s[r], e[r]), ae(s[r], t[r])) : t[r] != null ? s[r] = t[r] : delete s[r]);
  for (r in e)
    y(e, r) && !y(t, r) && de(e[r]) && (s[r] = ae({}, s[r]));
  return s;
}
function wt(e) {
  e != null && this.set(e);
...
var St = /(\[[^\[]*\])|(\\)?([Hh]mm(ss)?|Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Qo?|N{1,5}|YYYYYY|YYYYY|YYYY|YY|y{2,4}|yo?|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|kk?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g, Le = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, it = {}, _e = {};
function h(e, t, s, r) {
  var a = r;
...
function Ie(e, t) {
  return e.isValid() ? (t = rs(t, e.localeData()), it[t] = it[t] || Yr(t), it[t](e)) : e.localeData().invalidDate();
}
function rs(e, t) {
  var s = 5;
  function r(a) {
...
var as = /\d/, P = /\d\d/, ns = /\d{3}/, Dt = /\d{4}/, Be = /[+-]?\d{6}/, M = /\d\d?/, is = /\d\d\d\d?/, os = /\d\d\d\d\d\d?/, Ze = /\d{1,3}/, Yt = /\d{1,4}/, qe = /[+-]?\d{1,6}/, ge = /\d+/, Je = /[+-]?\d+/, Ir = /Z|[+-]\d\d:?\d\d/gi, Qe = /Z|[+-]\d\d(?::?\d\d)?/gi, Er = /[+-]?\d+(\.\d{1,3})?/, Re = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i, ke = /^[1-9]\d?/, bt = /^([1-9]\d|\d)/, Ue;
Ue = {};
function f(e, t, s) {
...
function Hr(e, t, s) {
  t != null && y(ht, e) && ht[e](t, s._a, s, e);
}
function Ke(e) {
  return e % 4 === 0 && e % 100 !== 0 || e % 400 === 0;
}
var T = 0, q = 1, H = 2, O = 3, A = 4, J = 5, ue = 6, $r = 7, jr = 8;
h("Y", 0, 0, function() {
  var e = this.year();
  return e <= 9999 ? $(e, 4) : "+" + e;
});
...
function we(e, t) {
  return function(s) {
    return s != null ? (us(this, e, s), d.updateOffset(this, t), this) : be(this, e);
  };
}
function be(e, t) {
  if (!e.isValid())
...
var qr = "January_February_March_April_May_June_July_August_September_October_November_December".split(
  "_"
), ds = "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"), cs = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/, Jr = Re, Qr = Re;
function Kr(e, t) {
  return e ? I(this._months) ? this._months[e.month()] : this._months[(this._months.isFormat || cs).test(t) ? "format" : "standalone"][e.month()] : I(this._months) ? this._months : this._months.standalone;
}
function Xr(e, t) {
  return e ? I(this._monthsShort) ? this._monthsShort[e.month()] : this._monthsShort[cs.test(t) ? "format" : "standalone"][e.month()] : I(this._monthsShort) ? this._monthsShort : this._monthsShort.standalone;
}
function ea(e, t, s) {
...
function hs(e) {
  return e != null ? (fs(this, e), d.updateOffset(this, !0), this) : be(this, "Month");
}
function sa() {
  return Ot(this.year(), this.month());
}
function ra(e) {
  return this._monthsParseExact ? (y(this, "_monthsRegex") || ms.call(this), e ? this._monthsShortStrictRegex : this._monthsShortRegex) : (y(this, "_monthsShortRegex") || (this._monthsShortRegex = Jr), this._monthsShortStrictRegex && e ? this._monthsShortStrictRegex : this._monthsShortRegex);
}
function aa(e) {
  return this._monthsParseExact ? (y(this, "_monthsRegex") || ms.call(this), e ? this._monthsStrictRegex : this._monthsRegex) : (y(this, "_monthsRegex") || (this._monthsRegex = Qr), this._monthsStrictRegex && e ? this._monthsStrictRegex : this._monthsRegex);
}
function ms() {
  function e(c, u) {
...
var ma = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), _s = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), pa = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), _a = Re, ya = Re, va = Re;
function ga(e, t) {
...
function Oa(e) {
  return this._weekdaysParseExact ? (y(this, "_weekdaysRegex") || Tt.call(this), e ? this._weekdaysStrictRegex : this._weekdaysRegex) : (y(this, "_weekdaysRegex") || (this._weekdaysRegex = _a), this._weekdaysStrictRegex && e ? this._weekdaysStrictRegex : this._weekdaysRegex);
}
function xa(e) {
  return this._weekdaysParseExact ? (y(this, "_weekdaysRegex") || Tt.call(this), e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex) : (y(this, "_weekdaysShortRegex") || (this._weekdaysShortRegex = ya), this._weekdaysShortStrictRegex && e ? this._weekdaysShortStrictRegex : this._weekdaysShortRegex);
}
function Ta(e) {
  return this._weekdaysParseExact ? (y(this, "_weekdaysRegex") || Tt.call(this), e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex) : (y(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = va), this._weekdaysMinStrictRegex && e ? this._weekdaysMinStrictRegex : this._weekdaysMinRegex);
}
function Tt() {
  function e(g, b) {
...
h("k", ["kk", 2], 0, Ca);
h("hmm", 0, 0, function() {
  return "" + Ct.apply(this) + $(this.minutes(), 2);
});
h("hmmss", 0, 0, function() {
  return "" + Ct.apply(this) + $(this.minutes(), 2) + $(this.seconds(), 2);
});
h("Hmm", 0, 0, function() {
...
function ie(e, t) {
  var s;
  return e && (C(t) ? s = te(e) : s = Pt(e, t), s ? Te = s : typeof console < "u" && console.warn && console.warn(
...
function Pt(e, t) {
  if (t !== null) {
    ...
    return D[e] = new wt(ct(r, t)), Se[e] && Se[e].forEach(function(a) {
      Pt(a.name, a.config);
    }), ie(e), D[e];
  } else
...
function Ia(e, t) {
  if (t != null) {
    var s, r, a = gs;
    D[e] != null && D[e].parentLocale != null ? D[e].set(ct(D[e]._config, t)) : (r = Xe(e), r != null && (a = r._config), t = ct(a, t), r == null && (t.abbr = e), s = new wt(t), s.parentLocale = D[e], D[e] = s), ie(e);
  } else
...
function Rt(e) {
  var t, s = e._a;
  return s && m(e).overflow === -2 && (t = s[q] < 0 || s[q] > 11 ? q : s[H] < 1 || s[H] > Ot(s[T], s[q]) ? H : s[O] < 0 || s[O] > 24 || s[O] === 24 && (s[A] !== 0 || s[J] !== 0 || s[ue] !== 0) ? O : s[A] < 0 || s[A] > 59 ? A : s[J] < 0 || s[J] > 59 ? J : s[ue] < 0 || s[ue] > 999 ? ue : -1, m(e)._overflowDayOfYear && (t < T || t > H) && (t = H), m(e)._overflowWeeks && t === -1 && (t = $r), m(e)._overflowWeekday && t === -1 && (t = jr), m(e).overflow = t), e;
}
...
function ks(e) {
  var t, s, r = e._i, a = Va.exec(r) || Ua.exec(r), n, i, o, c, u = Ae.length, g = ot.length;
  if (a) {
...
function Nt(e) {
  ...
  if (!e._d) {
    ...
    e._a[O] === 24 && e._a[A] === 0 && e._a[J] === 0 && e._a[ue] === 0 && (e._nextDay = !0, e._a[O] = 0), e._d = (e._useUTC ? Oe : na).apply(
      null,
      r
...
function Xa(e) {
  ...
  t = e._w, t.GG != null || t.W != null || t.E != null ? (n = 1, i = 4, s = me(
    ...
    e._a[T],
    xe(S(), 1, 4).year
  ), r = me(t.W, 1), a = me(t.E, 1), (a < 1 || a > 7) && (c = !0)) : (n = e._locale._week.dow, i = e._locale._week.doy, u = xe(S(), n, i), s = me(t.gg, e._a[T], u.year), r = me(t.w, u.week), t.d != null ? (a = t.d, (a < 0 || a > 6) && (c = !0)) : t.e != null ? (a = t.e + n, (t.e < 0 || t.e > 6) && (c = !0)) : a = n), r < 1 || r > K(s, n, i) ? m(e)._overflowWeeks = !0 : c != null ? m(e)._overflowWeekday = !0 : (o = ps(s, r, a, n, i), e._a[T] = o.year, e._dayOfYear = o.dayOfYear);
}
d.ISO_8601 = function() {
};
d.RFC_2822 = function() {
...
function Wt(e) {
  ...
  for (a = rs(e._f, e._locale).match(St) || [], g = a.length, s = 0; s < g; s++)
  ...
  m(e).charsLeftOver = o - c, t.length > 0 && m(e).unusedInput.push(t), e._a[O] <= 12 && m(e).bigHour === !0 && e._a[O] > 0 && (m(e).bigHour = void 0), m(e).parsedDateParts = e._a.slice(0), m(e).meridiem = e._meridiem, e._a[O] = en(
    ...
    e._a[O],
    e._meridiem
  ), u = m(e).era, u !== null && (e._a[T] = e._locale.erasConvertYear(u, e._a[T])), Nt(e), Rt(e);
}
function en(e, t, s) {
  var r;
...
function tn(e) {
  ...
  for (a = 0; a < c; a++)
    n = 0, i = !1, t = kt({}, e), e._useUTC != null && (t._useUTC = e._useUTC), t._f = e._f[a], Wt(t), gt(t) && (i = !0), n += m(t).charsLeftOver, n += m(t).unusedTokens.length * 10, m(t).score = n, o ? n < r && (r = n, s = t) : (r == null || n < r || i) && (r = n, s = t, i && (o = !0));
  ae(e, s || t);
}
function sn(e) {
  if (!e._d) {
...
function rn(e) {
  var t = new Pe(Rt(Ss(e)));
  return t._nextDay && (t.add(1, "d"), t._nextDay = void 0), t;
}
function Ss(e) {
  var t = e._i, s = e._f;
  return e._locale = e._locale || te(e._l), t === null || s === void 0 && t === "" ? ze({ nullInput: !0 }) : (typeof t == "string" && (e._i = t = e._locale.preparse(t)), E(t) ? new Pe(Rt(t)) : (Ce(t) ? e._d = t : I(s) ? tn(e) : s ? Wt(e) : an(e), gt(e) || (e._d = null), e));
}
function an(e) {
  var t = e._i;
  C(t) ? e._d = new Date(d.now()) : Ce(t) ? e._d = new Date(t.valueOf()) : typeof t == "string" ? Qa(e) : I(t) ? (e._a = es(t.slice(0), function(s) {
    return parseInt(s, 10);
  }), Nt(e)) : de(t) ? sn(e) : X(t) ? e._d = new Date(t) : d.createFromInputFallback(e);
}
function Ms(e, t, s, r, a) {
  var n = {};
  return (t === !0 || t === !1) && (r = t, t = void 0), (s === !0 || s === !1) && (r = s, s = void 0), (de(e) && vt(e) || I(e) && e.length === 0) && (e = void 0), n._isAMomentObject = !0, n._useUTC = n._isUTC = a, n._l = s, n._i = e, n._f = t, n._strict = r, rn(n);
}
function S(e, t, s, r) {
  return Ms(e, t, s, r, !1);
}
...
function et(e) {
  var t = Mt(e), s = t.year || 0, r = t.quarter || 0, a = t.month || 0, n = t.week || t.isoWeek || 0, i = t.day || 0, o = t.hour || 0, c = t.minute || 0, u = t.second || 0, g = t.millisecond || 0;
...
function _n(e, t, s) {
  ...
  if (e != null) {
    ...
    return !this._isUTC && t && (a = pt(this)), this._offset = e, this._isUTC = !0, a != null && this.add(a, "m"), r !== e && (!t || this._changeInProgress ? xs(
      this,
      V(e - r, "m"),
      1,
      !1
...
function Mn() {
  ...
  var e = {}, t;
  return kt(e, this), e = Ss(e), e._a ? (t = e._isUTC ? j(e._a) : S(e._a), this._isDSTShifted = this.isValid() && mn(e._a, t.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted;
}
function Dn() {
...
function V(e, t) {
  ...
  return Ee(e) ? s = {
    ...
    S(s.from),
    S(s.to)
  ), s = {}, s.ms = i.milliseconds, s.M = i.months), n = new et(s), Ee(e) && y(e, "_locale") && (n._locale = e._locale), Ee(e) && y(e, "_isValid") && (n._isValid = e._isValid), n;
}
V.fn = et.prototype;
V.invalid = hn;
function le(e, t) {
...
function xn(e, t) {
  var s;
  return e.isValid() && t.isValid() ? (t = Lt(t, e), e.isBefore(t) ? s = Zt(e, t) : (s = Zt(t, e), s.milliseconds = -s.milliseconds, s.months = -s.months), s) : { milliseconds: 0, months: 0 };
}
function Os(e, t) {
  return function(s, r) {
    var a, n;
    ...
    ), n = s, s = r, r = n), a = V(s, r), xs(this, a, e), this;
  };
}
function xs(e, t, s, r) {
  var a = t._milliseconds, n = mt(t._days), i = mt(t._months);
  e.isValid() && (r = r ?? !0, i && fs(e, be(e, "Month") + i * s), n && us(e, "Date", be(e, "Date") + n * s), a && e._d.setTime(e._d.valueOf() + a * s), r && d.updateOffset(e, n || i));
}
var Tn = Os(1, "add"), Cn = Os(-1, "subtract");
function Ts(e) {
  return typeof e == "string" || e instanceof String;
}
function Pn(e) {
  return E(e) || Ce(e) || Ts(e) || X(e) || Nn(e) || Rn(e) || e === null || e === void 0;
}
function Rn(e) {
  var t = de(e) && !vt(e), s = !1, r = [
    "years",
    "year",
    "y",
    "months",
...
function Ln(e, t) {
  ...
  var s = e || S(), r = Lt(s, this).startOf("day"), a = d.calendarFormat(this, r) || "sameElse", n = t && (G(t[a]) ? t[a].call(this, s) : t[a]);
  return this.format(
...
var $e = 1e3, ye = 60 * $e, je = 60 * ye, Ns = (365 * 400 + 97) * 24 * je;
function ve(e, t) {
  return (e % t + t) % t;
}
function Ws(e, t, s) {
  return e < 100 && e >= 0 ? new Date(e + 400, t, s) - Ns : new Date(e, t, s).valueOf();
}
function Fs(e, t, s) {
  return e < 100 && e >= 0 ? Date.UTC(e + 400, t, s) - Ns : Date.UTC(e, t, s);
}
function Xn(e) {
  var t, s;
  if (e = F(e), e === void 0 || e === "millisecond" || !this.isValid())
    return this;
  switch (s = this._isUTC ? Fs : Ws, e) {
    case "year":
      t = s(this.year(), 0, 1);
      break;
    case "quarter":
...
function vi(e) {
  return y(this, "_erasNameRegex") || It.call(this), e ? this._erasNameRegex : this._erasRegex;
}
function gi(e) {
  return y(this, "_erasAbbrRegex") || It.call(this), e ? this._erasAbbrRegex : this._erasRegex;
}
function ki(e) {
  return y(this, "_erasNarrowRegex") || It.call(this), e ? this._erasNarrowRegex : this._erasRegex;
}
function At(e, t) {
...
function Ci(e, t, s, r, a) {
  var n = ps(e, t, s, r, a), i = Oe(n.year, 0, n.dayOfYear);
...
l.millisecond = l.milliseconds = Is;
l.utcOffset = _n;
l.utc = vn;
l.local = gn;
l.parseZone = kn;
...
function Zi() {
  ...
  return e >= 0 && t >= 0 && s >= 0 || e <= 0 && t <= 0 && s <= 0 || (e += qt(_t(s) + t) * 864e5, t = 0, s = 0), r.milliseconds = e % 1e3, a = N(e / 1e3), r.seconds = a % 60, n = N(a / 60), r.minutes = n % 60, i = N(n / 60), r.hours = i % 24, t += N(i / 24), c = N(Hs(t)), s += c, t -= qt(_t(c)), o = N(s / 12), s %= 12, r.days = t, r.months = s, r.years = o, this;
}
function Hs(e) {
...
function qi(e) {
  ...
  if (e = F(e), e === "month" || e === "quarter" || e === "year")
    ...
    switch (t = this._days + Math.round(_t(this._months)), e) {
      case "week":
        return t / 7 + r / 6048e5;
      case "day":
        return t + r / 864e5;
...
var $s = se("ms"), Ji = se("s"), Qi = se("m"), Ki = se("h"), Xi = se("d"), eo = se("w"), to = se("M"), so = se("Q"), ro = se("y"), ao = $s;
function no() {
  return V(this);
}
function io(e) {
...
function st() {
  if (!this.isValid())
    return this.localeData().invalidDate();
  var e = lt(this._milliseconds) / 1e3, t = lt(this._days), s = lt(this._months), r, a, n, i, o = this.asSeconds(), c, u, g, b;
...
const wo = {
  ...
  setup(e, { emit: t }) {
    const s = e;
    d.locale("pt-br");
    const r = d(), a = r.format("YYYY-MM-DD"), n = Vt(""), i = Bs(() => [
    ...
    }), { __sfc: !0, props: s, emit: t, dataAtualMoment: r, dataAtualFormatada: a, iptModel: n, iptRules: i, pickerShow: o, pickerOnSelect: c, vMaska: vr };
  }
};
var So = function() {
  var t = this, s = t._self._c, r = t._self._setupProxy;
...
const Gs = No.exports, Wo = {
  __name: "VGlobalComponents",
  setup(e) {
    const t = ee(), { proxy: s } = yt(), r = s.$vuetify;
    return Zs(() => {
      s.$route && ut(
        () => s.$route.fullPath,
        () => t.resetarPrompts()
    ...
    }, VLoaderOverlay: js, VLoaderDialog: Gs, VCardToolbar: Jt };
  }
};
var Fo = function() {
  var t = this, s = t._self._c, r = t._self._setupProxy;
...
const Io = Ao.exports, Eo = (e, t = {}) => {
  const s = t.pinia || e.prototype.$pinia;
  if (!s) {
    console.error("[@eliaslazcano/vuetify] Pinia é necessário para esta biblioteca.");
    return;
  }
  e.prototype.$vuetifyComponentsStore = ee(s), e.component("VBtnTooltip", Xs), e.component("VCardToolbar", Jt), e.component("VContainerAsync", lr), e.component("VDateField", Yo), e.component("VGlobalComponents", Io), e.component("VLoaderDialog", Gs), e.component("VLoaderOverlay", js);
}, qo = { install: Eo };
export {
  Xs as VBtnTooltip,
  Jt as VCardToolbar,
  ...
  Yo as VDateField,
  Io as VGlobalComponents,
  Gs as VLoaderDialog,
  js as VLoaderOverlay,
  qo as default,
  zo as emitirAlert,
  Bo as emitirDialog,
  Zo as emitirPrompt,
  Go as emitirSnack,
  $o as getLoaderOverlayStatus,
  Eo as install,
  jo as setLoaderDialog,
  Ho as setLoaderOverlay,
