...
import { getCurrentInstance as c, onMounted as _, watch as y } from "vue";
const m = v("vuetifyComponentsStore", {
  state: () => ({
    loaderOverlayShow: !1,
    loaderDialogShow: !1,
    loaderText: "",
...
function p(s, t, o, r, e, a, i, n) {
  var l = typeof s == "function" ? s.options : s;
  return t && (l.render = t, l.staticRenderFns = o, l._compiled = !0), {
    exports: s,
    options: l
  };
}
...
const f = D.exports, T = {
  __name: "EGlobalUI",
  setup(s) {
    const t = m(), { proxy: o } = c(), r = o.$vuetify;
    return _(() => {
      o.$route && y(
        () => o.$route.fullPath,
        () => t.resetarPrompts()
      );
    }), { __sfc: !0, vuetifyComponentsStore: t, proxy: o, vuetify: r, promptOnOk: (a, i, n = () => {
    }, l = "") => {
      a.validate() && (n(l), t.removerPrompt(i));
...
const L = G.exports, V = {
  install(s, t = {}) {
    ...
    s.prototype.$vuetifyComponentsStore = m(o), s.component("EGlobalUi", L), s.component("EGlobalLoaderOverlay", d), s.component("EGlobalLoaderDialog", u), s.component("VCardToolbar", f);
  }
};
export {
  V as default
